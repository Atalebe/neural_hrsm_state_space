...
This version uses the combined strict-v2 manuscript figure suite and expands
the manuscript narrative around:
    - Allen Brain Observatory / Visual Coding Neuropixels dataset provenance
    - strict fixed-scale cohort construction
    - HRSM proxy definitions and residualization audit
    - aligned-lag memory model and shuffled-lag controls
    - cross-session target synthesis
    - variance/autocorrelation residual audit
    - lag-ablation audit
    - descriptive ripeness analysis
"""
